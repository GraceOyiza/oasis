...
const Steps = ({bgColor = "#258575", guideSteps = [], subGuideSteps=[]}) => {
  return (
    <>
      <section>
        <div className="pt-10 md:pt-[10rem] pb-20 custom-container lg:mt-[7rem]"  style={{backgroundColor: bgColor}}>
          ...
          <div className="custom-container">     
            <div className="flex flex-col md:flex-row md:flex-wrap gap-12 p-14 lg:px-0">
              ...
              (
                ...
                <div key={`steps-${index}`} className="bg-[#1B1B1B]/[0.05] w-full lg:w-[48%]">
                   <div className=" p-20">
