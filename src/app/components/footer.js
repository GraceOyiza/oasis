            ...
            <div
              className={`${
                useAltNewsletterSection
                  ? "bg-[#0ECFAF] bg-opacity-10"
                  : "bg-[#001A15]"
              } flex flex-col items-center p-8 lg:pt-40 pb-20`}
            >
              <h3
                className={`${
                  useAltNewsletterSection ? "text-[1B1B1B]" : "text-white"
                } font-semibold text-center text-4xl lg:text-7xl`}
              >
                Subscribe to Newsletter
              </h3>
              <p
                className={`${
                  useAltNewsletterSection ? "text-[1B1B1B]" : "text-[#BEBEBE]"
                }   text-xl lg:text-3xl my-14`}
              >
          ...
          <div className="p-8 md:py-14">
            <div>
              <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-8 md:justify-between">
                ...
                <div>
                  <h4 className="text-2xl lg:text-3xl font-semibold text-[#1B1B1B] capitalize mb-8 text-center md:text-left">
                    About Us
                  </h4>
                ...
                <div>
                  ...
                  <ul className="flex flex-row  items-center md:items-start gap-3 justify-center text-[#1B1B1B]">
                    <li className="border rounded-full border-[#0C111A] p-2 w-[3.5rem] h-[3.5rem] flex justify-center items-center">
                      <Link href="/" className="text-[1.4rem]">
                        <LinkedIn />
                      </Link>
                    </li>
              ...
              <div className="flex flex-col md:flex-row items-center mb-12 justify-between">
                <p className="text-[#1B1B1B] text-2xl">
                  © 2022 Oasis & Oaks. All rights reserved.{" "}
                </p>
                <ul className="mt-6 md:mt-0 flex gap-8">
                  <li>
                    <Link
                      href="/"
                      className="text-[#1B1B1B] text-xl capitalize"
                    >
                      Terms
                    </Link>
                  </li>
